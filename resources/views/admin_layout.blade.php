...
<body>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="#"><span>welcome admin</span></a>
				...
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							...
							<ul>
								<li><a class="submenu" href="{{URL::to('/add-product')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> </span>add product</a></li>
						...
						<li>
							...
							<ul>
								<li><a class="submenu" href="{{URL::to('/add-slider')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> </span>add slider</a></li>
	...
	<footer>
		...
		<p>
			...
			<span class="hidden-phone" style="text-align:right;float:right">Powered by: <a href="http://admintemplates.co/" alt="Bootstrap Admin Templates">safy</a></span>
		</p>
	...
	<script src="{{asset('backend/js/jquery.flot.resize.min.js')}}"></script>
		...
		<script src="{{asset('backend/js/jquery.iphone.toggle.')}}"></script>
