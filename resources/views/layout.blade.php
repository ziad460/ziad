...
<head>
    ...
    <link href="{{asset('fronyend/css/price-range.css')}}" rel="stylesheet">
...
<body>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> 01067452363</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> ziad5827@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							<ul class="nav navbar-nav">
								<li><a href="https://www.facebook.com/profile.php?id=100006028657997"><i class="fa fa-facebook"></i></a></li>
								<li><a href="https://twitter.com/ziad76892"><i class="fa fa-twitter"></i></a></li>
								<li><a href="https://www.linkedin.com/in/ziad-ahmed-447753182/"><i class="fa fa-linkedin"></i></a></li>
				...
				<div class="row">
					...
					<div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                 <li><a href="{{URL::to('/admin')}}"><i class="fa fa-crosshairs"></i> Admin account</a></li>
                         ...
                         <?php }else{?>
                                ...
                                <li><a href="{{URL::to('/login-check')}}"><i class="fa fa-lock"></i> Login & sign up</a></li>
                            <?php } ?>
                            </ul>
                        </div>
                    </div>
	...
	<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2020 ZiadAhmed. All rights reserved.</p>
					<p class="pull-right">Designed by <span><a target="_blank" href="ziad5827@gmail.com">Ziad Ahmed</a></span></p>
				</div>
			</div>
		</div>
